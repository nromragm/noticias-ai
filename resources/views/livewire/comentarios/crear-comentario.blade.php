...
<form wire:submit.prevent="comentar" class="mb-6">
    <textarea
        ...
        class="w-full p-2 border rounded mb-2 bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 border-gray-300 dark:border-gray-700 placeholder-gray-500 dark:placeholder-gray-400"
