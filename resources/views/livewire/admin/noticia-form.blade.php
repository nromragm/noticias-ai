    ...
    <form wire:submit.prevent="save" class="space-y-6">
        ...
        <div class="flex flex-col md:flex-row gap-4">
            <div class="flex-1">
                ...
                <input type="text" wire:model.defer="categoria" class="w-full rounded border-gray-300 dark:bg-gray-900 dark:text-gray-100 focus:ring focus:ring-blue-200" required>
